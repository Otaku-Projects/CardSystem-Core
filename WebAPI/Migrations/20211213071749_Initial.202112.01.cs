...
{
    public partial class Initial20211201 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationSystem", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_ApplicationSystem_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationFunction", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationFunction_ApplicationSystem_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "ApplicationSystem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationFunctionSystemUserRole_AspNetRoles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationFunction_ApplicationId",
                table: "ApplicationFunction",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationFunction_FunctionGroupId",
                table: "ApplicationFunction",
